...
def gen_deltatable():
	...
	Very similar to csv_deltatable function below. That function takes
	...
	#exactly the same with the output of csv_deltatable function
...
def csv_deltatable(csvdir=test_dir,file=test_csv): 
	"""
	...
	This is a 'from Fragman' implementation, gen_deltatable is our own implementation
	"""
